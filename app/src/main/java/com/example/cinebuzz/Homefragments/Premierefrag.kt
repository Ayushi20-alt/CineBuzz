...
class Premierefrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View =  inflater.inflate(R.layout.fragment_premierefrag, container, false)

         recyclerView = view.findViewById(R.id.recyclerviewpremiere)
